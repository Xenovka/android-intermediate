package com.dicoding.storyapp.ui.view.camera
...
class CameraActivity : AppCompatActivity() {
    ...
    private fun startCamera() {
        ...
        cameraProvider.addListener({
            val camera: ProcessCameraProvider = cameraProvider.get()
            ...
            try {
                ...
                Toast.makeText(this@CameraActivity, "Failed to load camera", Toast.LENGTH_SHORT).show()
            }
        }, ContextCompat.getMainExecutor(this))
    }
